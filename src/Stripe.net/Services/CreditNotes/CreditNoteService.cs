namespace Stripe
{
        ...
        IUpdatable<CreditNote, CreditNoteUpdateOptions>
    {
        ...
        public virtual CreditNote Preview(string id, CreditNoteundefinedOptions options = null, RequestOptions requestOptions = null)
        {
            return this.Request(HttpMethod.Get, /v1/credit_notes/preview, options, requestOptions);
        }

        public virtual Task<CreditNote> PreviewAsync(string id, CreditNoteundefinedOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            return this.RequestAsync(HttpMethod.Get, /v1/credit_notes/preview, options, requestOptions, cancellationToken);
        }

        public virtual CreditNoteLinesList PreviewLines(string id, CreditNoteundefinedOptions options = null, RequestOptions requestOptions = null)
        {
            return this.Request<CreditNoteLinesList>(HttpMethod.Get, /v1/credit_notes/preview/lines, options, requestOptions);
        }

        public virtual Task<CreditNoteLinesList> PreviewLinesAsync(string id, CreditNoteundefinedOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public virtual CreditNote VoidCreditNote(string id, CreditNoteundefinedOptions options = null, RequestOptions requestOptions = null)
        {
            return this.Request(HttpMethod.Post, $"{this.InstanceUrl(id)}/void", options, requestOptions);
        }

        public virtual Task<CreditNote> VoidCreditNoteAsync(string id, CreditNoteundefinedOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
