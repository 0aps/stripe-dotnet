namespace Stripe
{
        ...
        IUpdatable<Source, SourceUpdateOptions>
    {
        ...
        public virtual unknown Detach(string id, SourceundefinedOptions options = null, RequestOptions requestOptions = null)
        {
            return this.Request<unknown>(HttpMethod.Delete, /v1/customers/{customer}/sources/{id}, options, requestOptions);
        }

        public virtual Task<unknown> DetachAsync(string id, SourceundefinedOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public virtual ApmsSourcesSourceTransactionList SourceTransactions(string id, SourceundefinedOptions options = null, RequestOptions requestOptions = null)
        {
        ...
        public virtual Task<ApmsSourcesSourceTransactionList> SourceTransactionsAsync(string id, SourceundefinedOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public virtual Source Verify(string id, SourceundefinedOptions options = null, RequestOptions requestOptions = null)
        {
            return this.Request(HttpMethod.Post, $"{this.InstanceUrl(id)}/verify", options, requestOptions);
        }

        public virtual Task<Source> VerifyAsync(string id, SourceundefinedOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
